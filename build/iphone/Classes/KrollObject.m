 ...
 * Copyright (c) 2009-2011 by Symble, Inc. All Rights Reserved.
...
//@interface SymbleObject : NSObject
//@end

@interface SymbleObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[SymbleObject class]])
		{
			for (NSString *key in [[(SymbleObject*)o modules] allKeys])
			{
