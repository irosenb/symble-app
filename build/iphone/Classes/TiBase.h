...
// in simulator we redefine to format for Symble Developer console
...
{\
	NSString * exceptionName = [@"org.symble." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.symble";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UISymbleNativeItemNone = -1, 
	UISymbleNativeItemSpinner = -2,
	UISymbleNativeItemProgressBar = -3,
	
	UISymbleNativeItemSlider = -4,
	UISymbleNativeItemSwitch = -5,
	UISymbleNativeItemMultiButton = -6,
	UISymbleNativeItemSegmented = -7,
	
	UISymbleNativeItemTextView = -8,
	UISymbleNativeItemTextField = -9,
	UISymbleNativeItemSearchBar = -10,
	
	UISymbleNativeItemPicker = -11,
	UISymbleNativeItemDatePicker = -12,
	
	UISymbleNativeItemInfoLight = -13,
	UISymbleNativeItemInfoDark = -14,
	
	UISymbleNativeItemDisclosure = -15,
	
	UISymbleNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Symble instances of
